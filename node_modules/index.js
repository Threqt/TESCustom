...
bot.on("message", async message => {
  ...
  if(cmd === `${prefix}botinfo`){
    const embed = new Discord.RichEmbed()
               ...
               .addField(`Latest Release`, `[The Evening Standard 12th Release](https://docs.google.com/presentation/d/1tmFdrrwJV_-sPxFF7JnX-qGC-yo_GJMcBZxWkuzpbTs/edit?usp=sharing)`)
